...
export function checkIsEmailGenerated(email: string, userId?: string): boolean {
  ...
  // Check in active unsubmitted saved accounts
  ...
  // Check in all generated history
...
// Helpers for daily generate quota
...
export function GmailGenerator({
  ...
  return (
    <div className="bg-white rounded-3xl p-6 sm:p-7 border border-indigo-100 shadow-xs space-y-5">
      ...
      {/* Control Panel: Count Selector & Generate Button */}
              ...
              {results.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Action buttons: Pilih Stor, copy email & password */}
